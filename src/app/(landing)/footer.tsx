        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:mb-0">
            <Link href="/" className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold "> Analyzr</h2>
            </Link>
            ...
            <p className="text-sm dark:text-gray-400  mt-5">
              © {new Date().getFullYear()}  Analyzr. All rights reserved.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="https://github.com/ezeslucky/Analyzr2.0.git" className="text-gray-600 hover:text-black dark:text-gray-400 dark:hover:text-white">
                    Github
                  </Link>
                </li>
                <li>
